...
class SPUtils {
  ...
  ///住记词
  static Future<bool> saveMnemonic(String mnemonic) {
    return _spf.setString('key_mnemonic', mnemonic);
  }
  ///获取住记词
  static String getMnemonic() {
    return _spf.getString('key_mnemonic');
  }
  ///保存BOOL地址
  static Future<bool> saveBool(String bool) {
    return _spf.setString('key_bool', bool);
  }
  ///获取BOOL地址
  static String getBool() {
    return _spf.getString('key_bool');
  }
  ///是否已存在钱包
  static bool isCreated() {
    String bool = getBool();
    return bool != null && bool.isNotEmpty;
  }
}
